  ...
  return (
    <nav className=" lg:px-4 shadow-md flex items-center justify-center">
      <div className="flex w-[90%] mx-auto items-center justify-between">
        ...
        <ul className="flex text-lg font-medium items-center">
          ...
          <li className="flex gap-3 ml-3">
            <button className="px-4 py-2 border rounded-xl hover:scale-105 hover:shadow-xl transition-all duration-300 bg-gradient-to-t from-orange-400 to-red-200 cursor-pointer">
              Get Our App
            </button>
            <button className="px-4 py-2 border-2 border-orange-400 rounded-xl hover:scale-105 hover:shadow-xl transition-all duration-300 cursor-pointer">
              Login/Signup
            </button>
          </li>
        </ul>
